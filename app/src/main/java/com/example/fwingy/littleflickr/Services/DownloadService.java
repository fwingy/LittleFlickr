...
public class DownloadService extends Service implements DownloadListener{
    ...
    public void onSuccess() {
        ...
        Toast.makeText(DownloadService.this, getString(R.string.notification_download_suceess), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onFailed() {
        ...
        Toast.makeText(DownloadService.this, getString(R.string.notification_download_failed), Toast.LENGTH_SHORT).show();
    }
    ...
    public class DownloadBinder extends Binder {
        public void startDownload(String url) {
            if (mDownloadTask == null) {
                mDownloadUrl = url;
                mDownloadTask = new DownloadTask(DownloadService.this);
                mDownloadTask.execute(mDownloadUrl);
                startForeground(1, getNotification(getString(R.string.notification_downloading), 0));
                Toast.makeText(DownloadService.this, getString(R.string.notification_downloading), Toast.LENGTH_SHORT).show();
            }
        }
    }
